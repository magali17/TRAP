...
dem0.1 <- dem0.0 %>% 
  ...
  select(
    ...
    ### --> update _SP to _ST later
    
    # exp avg & coverage variables
    contains("_SP"), #exp_avg01_yr_SP:exp_wks_coverage20_yr_ST,
...
no2 <- dem1 %>% 
  ...
  rename(
    ...
    # don't need these anymore b/c all pollutant values Should be the same since this is based on residential address  alone
    # no2_imputed_coverage10_yr = imputed_coverage10_yr,
    # no2_exact_coverage10_yr = exact_coverage10_yr, 
    # no2_exact_coverage01_yr = exact_coverage01_yr
...
pm25 <- dem1 %>% 
  ...
  rename(
    ...
    pm25_1yr = exp_avg01_yr_SP,
    pm25_5yr = exp_avg05_yr_SP,
    pm25_10yr = exp_avg10_yr_SP,
    pm25_20yr = exp_avg20_yr_SP,
    pm25_10yr10yrlag = exp_avg10_yr10yrlag_SP,
    pm25_10yr05yrlag = exp_avg10_yr05yrlag_SP,
    ...
    pm25_coverage_1yr = exp_wks_coverage01_yr_SP,
    pm25_coverage_5yr = exp_wks_coverage05_yr_SP,
    pm25_coverage_10yr = exp_wks_coverage10_yr_SP,
    pm25_coverage_20yr = exp_wks_coverage20_yr_SP,
    pm25_coverage_10yr10yrlag = exp_wks_coverage10_yr10yrlag_SP,
    pm25_coverage_10yr05yrlag = exp_wks_coverage10_yr05yrlag_SP,
...
dem_65_no2 <- dem0.1_65 %>% 
   ...
   rename(
    ...
    # don't need this anymore b/c these are soley based on location
...
?? only include people w/ impuaiton quality < 1? or 0? 
