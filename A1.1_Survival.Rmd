...
# using everyone enrolled in study at any oen time (peson-years)
no2_by_avg_prds <- dem1 %>%
...
dem1 %>%
  ...
  geom_smooth(data=no2_by_avg_prds, aes(y=NO2_ppb, col=Avg_Prd), 
              # method="lm",
              # formula = y ~ splines::bs(x, 1000)
              #formula = y ~x, method
              ) + 
    labs(x = "Year",
         y = "NO2 Exposure (ppb)",
