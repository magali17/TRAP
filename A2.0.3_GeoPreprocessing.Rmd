...
act_in_study0 <- read.csv(file.path("..", "Write Up", "1. Proposal", "Aim 2. 2019 UFP", "GIS", "ACT", "ACT_selected", "cohort_in_monitoring_area_0.04deg_buffer.csv")) %>%
...
cov_mm0 %>%
  map_fn(color_map = F, 
         ...
         map_title = "Mobile monitoring and study areas"
         )
