...
#load data
stops0 <- readRDS(file.path("Data", "Aim 2", "Mobile Monitoring", "mm_stops_2020-03-17.rda")) 
...
```{r}
data.frame(
  Analysis =  c("primary", "stop_means", "trim10", "windsorize", "uw")) %>%
...
# saveRDS(annual, file.path("Data", "Aim 2", "Mobile Monitoring", "annual_2020-03-17.rda"))
...
#   unique() %>%
#   right_join(annual) %>%
#   write.csv(., file.path("Data", "Aim 2", "Mobile Monitoring", "annual_2020-03-17_loc&avg.csv"))
