...
### --> update covariates; drop time-varying covariates; 
...
### --> DROP OTHER TIME-VARYING COVARIATES?
...
Compare UFP vs BC predictions in study area.
...
uk_predictions_df_l %>%
  ...
  kable(caption = "Distribution of UK predictions for ACT locations from primary and sensitivity analyses") %>%
  kable_styling()
