...
```{r}
# --> to do
# map predictions on grid
# how else should the models be evaluated?
...
base_map_pred +
  # don't include monitoring/study area of this to work
...
uk_decompose %>%
colo.plot(x.variable = "uk_prediction", x.label = "UK Prediction",
          y.variable = "regression_prediction", y.label = "Regression Prediction",
          rmse.digits = 2,
          coef_digits = 2
          ) 
...
e.g. model, CV R2, RMSE
```{r}

```

#### --> add maps to show prediction differences; have a "difference" in predictions map?
