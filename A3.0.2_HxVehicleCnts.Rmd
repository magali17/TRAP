...
p2005 <- compare.fn(mydata = compare, 
                    x= "AADT_sections_2005_09", x.label = "DOT AADT Estimates", 
           y = "AADT_points_2005_09", y.label = "AADT Based on 2 Nearest Hwy Points",
           plot.title = ""
           )

## 2010 - 2014
p2010 <- compare.fn(mydata = compare,
                    x= "AADT_sections_2010_14", x.label = "DOT AADT Estimates", 
                    y = "AADT_points_2010_14", y.label = "AADT Based on 2 Nearest Hwy Points"
                    )
