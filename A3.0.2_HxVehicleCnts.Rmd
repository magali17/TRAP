...
#eliminates plot background lines, makes axis text little bigger 
...
compare.fn <- function(mydata = compare, x, y,
                       x.label = "road section counts",
                       y.label = "estimates using point counts",
                       plot.title = "") {
...
```{r}
## 2005-2009
p2005 <- compare.fn(x= "AADT_sections_2005_09",
           y = "AADT_points_2005_09", plot.title = "")

## 2010 - 2014
p2010 <- compare.fn(x= "AADT_sections_2010_14",
           y = "AADT_points_2010_14")

## 2015 - 2018
p2015 <- compare.fn(x= "AADT_sections_2015_18",
