...
### --> make some plots to visualize data plot above 
...
### --> ? estimate using increasing buffers only if there are NAs in smaller buffers? 
### --> compare yearly, not just in 5-yr grps? 
