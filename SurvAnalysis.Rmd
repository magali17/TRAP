...
dem0 <- read_sas("~/a. TRAP Project/R TRAP Project/data/issue_001.sas7bdat", 
    NULL)
...
kable(median.bsl.expo, digits = 0, caption = "Median NO2 (ppb) and PM2.5 (µg/m3) concentration at baseline")
