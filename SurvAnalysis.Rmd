...
dem0.0 <- read_sas(file.path("~", "a. TRAP Project", "R TRAP Project", "data", "issue_001.sas7bdat"), NULL)
...
dem <- dem0 %>%
  ...
  mutate(
    ...
    ## --> EDIT 
    dementia_now = ifelse(age_at_end_exposure_year < age_last_visit, 0, anydementia),
    #clean up variables
